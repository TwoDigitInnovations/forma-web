...
const WorkplanProgress = ({ activities }) => {
    ...
    return (
        <div className="py-4">
            ...
            <div className="border rounded-xl shadow bg-custom-black overflow-hidden">
                ...
                {/* Table Header */}
                <div className="hidden sm:grid grid-cols-5 gap-4 px-4 py-3 text-black text-sm font-semibold bg-custom-yellow">
                    <div>Description</div>
                    <div>Qty in BOQ</div>
                    <div>Qty Done</div>
                    <div>Weight</div>
                                        ...
                                        <div className="sm:hidden flex flex-col gap-3">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <input
                                                    ...
                                                    value={act.qtyInBOQ}
                                                    onChange={(e) =>
                                                        handleChange(section.id, act.id, "qtyInBOQ", e.target.value)
                                                    }
                                                />
                                            </div>
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <input
                                                    ...
                                                    value={act.qtyDone}
                                                    onChange={(e) =>
                                                        handleChange(section.id, act.id, "qtyDone", e.target.value)
                                                    }
                                                />
                                            </div>
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <input
                                                    ...
                                                    value={act.weight}
                                                    onChange={(e) =>
                                                        handleChange(section.id, act.id, "weight", e.target.value)
                                                    }
                                                />
                                            </div>
