    ...
    return (
        <div className="w-full rounded-lg md:p-8 p-4">
            <div className="flex md:flex-row flex-col items-start gap-4 md:gap-0 md:items-center justify-between mb-6">
                <h1 className="text-2xl md:text-3xl font-bold text-white">Project Summary</h1>
                <div className="flex flex-wrap gap-3">
                    {[
                        ...
                        <button
                            key={i}
                            onClick={btn.toggle}
                            className={`md:px-4 px-2 py-2 rounded-lg text-sm md:text-md font-medium transition-colors ${btn.active ? 'bg-custom-yellow text-gray-900' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                }`}
                        >
                            + {btn.label}
                        </button>
                    ))}
                    <button className="md:px-4 px-3 py-2 bg-red-500 text-white rounded-lg font-medium hover:bg-red-600 transition-colors text-sm md:text-md ">
                        Download PDF
                    </button>
                </div>
            </div>
