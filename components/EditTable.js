      ...
      <table className="w-full border-collapse text-sm">
        <thead>
          <tr className="bg-gray-100 text-gray-700">
            <th className="py-2 px-3 text-left w-[100px]">#</th>
            <th className="py-2 px-3 text-left min-w-[250px]">Description</th>
            <th className="py-2 px-3 text-center w-[120px]">Duration</th>
            <th className="py-2 px-3 text-center w-[150px]">Start Date</th>
            <th className="py-2 px-3 text-center w-[150px]">End Date</th>
            <th className="py-2 px-3 text-center w-[150px]">Actions</th>
          </tr>
        </thead>
        <tbody>
