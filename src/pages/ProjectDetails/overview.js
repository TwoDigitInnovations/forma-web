        ...
        <div className=" mb-6 relative overflow-hidden grid md:grid-cols-2 gap-6">
              ...
              <div className="flex  items-center gap-6 text-gray-300">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs">
                    Last Updated: {formatSimpleDate(projectDetails?.updatedAt)}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-xs">
                    💰 Budget: ${projectDetails.projectBudget}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-2xl bg-custom-black p-6">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                className="flex items-center gap-2 bg-[#DFF349] text-black px-4 py-1.5 rounded-lg font-medium hover:opacity-80 cursor-pointer text-[15px]"
              ...
              <button
                className="flex items-center gap-2 bg-[#DFF349] text-black px-4 py-1.5 rounded-lg font-medium hover:opacity-80 cursor-pointer text-[15px]"
                onClick={() => router.push(`/ProjectDetails/siteLogs`)}
              >
                Site Logs
                <Image size={18} />
              </button>
              <button
                className="flex items-center gap-2 bg-[#DFF349] text-black px-4 py-1.5 rounded-lg font-medium hover:opacity-80 cursor-pointer text-[15px]"
                onClick={() => router.push(`/ProjectDetails/documents`)}
              >
                Documents
                <Image size={18} />
              </button>
